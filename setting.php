...
<div class="col-sm-4">
<input type="text" class="form-control" name="business_web" id="business_web"  required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Company Portal Address</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="portal_addr" id="postal_addr"  required="">
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" class="form-control" name="curr_sym" id="curr_sym"  required="">
<span class="messages"></span>
</div>
...
<div class="col-sm-4">
<input type="text" class="form-control" name="def_tax" id="def_tax"  required="">
<span class="messages"></span>
</div>
