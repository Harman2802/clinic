...
?>
  ...
  <div class="row col-lg-12">Welcome to Dr Pawanaroa Clinic<br><br></div>
...
<?php if($_SESSION['user'] == 'admin'){ ?>
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
    ...
    if (!$rspat) {
      continue;  // Skip this iteration if no patient found
    }
    ...
    if (!$rsdept) {
      continue;  // Skip this iteration if no department found
    }
    ...
    if (!$rsdoc) {
      continue;  // Skip this iteration if no doctor found
    }
